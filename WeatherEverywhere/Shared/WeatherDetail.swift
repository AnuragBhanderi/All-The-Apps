...
struct WeatherDetail: View {
    ...
    var body: some View {
        Group{
            ...
            container
            #else
            container.frame(minWidth: 500, idealWidth: 700, maxWidth: .infinity, minHeight: 300, maxHeight: .infinity)
            #endif
        }
        .padding()
    ...
    var container: some View {
        VStack (alignment: .leading, spacing: 20){
            VStack(alignment: .leading){
                ...
                return NSItemProvider(object:forecast.condition_desc as NSString)
            }
